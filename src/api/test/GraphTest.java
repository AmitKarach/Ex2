...
// GRAPH TEST - TODO - Update as soon as other Functions are written and work!
class GraphTest {
    ...
    @Test
    final void Amit() { // HAI BSERET MADE A TEST ON HIS NAME
        DWGraph_DS g = new DWGraph_DS();
        node_data n = new NodeData(2);
        node_data n1 = new NodeData(4);
        g.addNode(n);

...
to activate it simlply open the jar in the file and enter you name and level or open the jar with command line and again enter id and level number lets see what score you will get:)
